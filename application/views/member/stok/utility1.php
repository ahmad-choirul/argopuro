        ...
        <div class="inner-wrapper">
            ...
            <section role="main" class="content-body">
                    ...
                    <header class="panel-heading">
                        <div class="row show-grid">
                            <div class="col-md-6" align="left">
                                <h2 class="panel-title">Data Utility Stok</h2>
                            </div>
                            <?php
                            echo level_user('stok', 'utility', $this->session->userdata('kategori'), 'add') > 0 ? '<div class="col-md-6" align="right"><a class="btn btn-success" href="#"  data-toggle="modal" data-target="#tambahData"><i class="fa fa-plus"></i> Tambah</a></div>' : '';
                            ?>
                        </div>
                    </header>
                      ...
                      <form action="" method="get">
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <input type="text" id="firstdate" <?php if ($this->input->get('firstdate')!='') {
                                    echo "value=".$this->input->get('firstdate');
                                } ?>  name="firstdate" class="form-control tanggal_masa">
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="form-group">
                                <label class="control-label">Tanggal Akhir</label>
                                <input type="text" <?php if ($this->input->get('lastdate')!='') {
                                    echo "value=".$this->input->get('lastdate');
                                } ?> id="lastdate" name="lastdate" class="form-control tanggal_masa">
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                          <div class="form-group">
                            <label>Item</label>
                            <select data-plugin-selectTwo class="form-control" name="kode_item" id="kode_item" onchange="this.form.submit()">                    <option value="">Pilih semua</option>
                              <?php foreach ($select_item as $key => $value): ?>
                                <option value="<?php echo $key ?>" <?php echo ($kode_item == $key) ? 'selected' : ''; ?>><?php echo $value ?></option>
                            <?php endforeach ?>
                        </select> 
                    </div>
                    <!-- /.form-group -->
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    <label>Kasir</label>
                    <select data-plugin-selectTwo class="form-control" name="id_admin" id="id_admin" onchange="this.form.submit()">                    
                        <option value="">Pilih semua</option>
                        <?php foreach ($select_kasir as $key => $value): ?>
                            <option value="<?php echo $key ?>" <?php echo ($id_admin == $key) ? 'selected' : ''; ?>><?php echo $value ?></option>
                        <?php endforeach ?>
                    </select> 
                </div>
            </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <section class="panel panel-primary">
                <?php echo form_open('stok/stokutilitytambah', ' id="FormulirTambah"'); ?>
                <header class="panel-heading">
                    <h2 class="panel-title">Tambah Utility Stok</h2>
                </header>
                <div class="panel-body">
                    ...
                    <div class="form-group kuantiti_berubah">
                        <label class="col-sm-3 control-label">Perubahan Stok<span class="required">*</span></label>
                        <div class="col-sm-4">
...
<script type="text/javascript">
   ...
   var tableitems = $('#stokdata').DataTable({
    ...
    "ajax": {
        ...
        "type": "GET",
        "data": function ( data ) {
            data.kode_item = $('#kode_item').val();
            data.id_admin = $('#id_admin').val();
