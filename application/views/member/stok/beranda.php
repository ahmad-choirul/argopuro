												...
												<div class="widget-content">
													<ul class="mg-folders" style="background-color: #003659;">
                                                        ...
                                                        <li>
                                                         ...
                                                         <li>
                                                            <a href="<?php echo base_url()?>Pembelian/transfer_stok" class="menu-item" style="color: white"><i class="fa fa-folder"></i>Transfer Stok</a>
                                                            <div class="item-options">
                                                                <a href="<?php echo base_url()?>Pembelian/transfer_stok">
                                                                    <i class="fa fa-arrow-circle-o-left"></i>
                                                                </a> 
                                                            </div>
                                                        </li> 
