    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <section class="panel panel-primary">
                ...
                <header class="panel-heading">
                    <h2 class="panel-title">Tambah Petani</h2>
                </header>
                <div class="panel-body">
                    ...
                    <div class="form-group mt-lg nama_pembeli">
                        <label class="col-sm-3 control-label">Kontak<span class="required">*</span></label>
                        <div class="col-sm-9">
                            <input type="text" name="hp" class="form-control" required/>
                        </div>
                    </div>

                    <div class="form-group nama_pembeli">
                        <label class="col-sm-3 control-label">Stok Awal<span class="required">*</span></label>
                        <div class="col-sm-9">
                    ...
                    <div class="form-group nama_pembeli">
                        <label class="col-sm-3 control-label">Jenis Pembeli<span class="required">*</span></label>
                        <div class="col-sm-9">
                         <input type="text" name="jenis_pembeli" class="form-control" required/>
                     </div>
                 </div>
                 <div class="form-group nama_pembeli">
                        <label class="col-sm-3 control-label">Luas Sawah<span class="required">*</span></label>
                        <div class="col-sm-9">
                         <input type="text" name="luas_sawah" class="form-control" required/>
                     </div>
                 </div>
                ...
                <div class="panel-body">
                  ...
                  <div class="form-group telepon">
                    <label class="col-sm-3 control-label">penjual</label>
                        <select data-plugin-selectTwo class="form-control" required id="id_penjual" name="id_penjual">  
      ...
      $.ajax({
        ...
        success: function(response) { 
            ...
            $.each(response, function(i, item) {
                ...
                datarow+="<tr><td>Kontak</td><td>: "+item.hp+"</td></tr>";
                datarow+="<tr><td>Stok Awal</td><td>: "+item.stok_awal+"</td></tr>";
                datarow+="<tr><td>Luas Sawah</td><td>: "+item.luas_sawah+"</td></tr>";
                datarow+="<tr><td>Total</td><td>: "+item.total+"</td></tr>";
                datarow+="<tr><td>Jenis Pembeli</td><td>: "+item.jenis_pembeli+"</td></tr>";
      ...
      $.ajax({
        ...
        success: function(response) {  
            $.each(response, function(i, item) { 
                ...
                document.getElementById("jenis_pembeli").value = item.jenis_pembeli;
                document.getElementById("luas_sawah").value = item.luas_sawah;
                document.getElementById("id_penjual").value = item.id_penjual;
            }); 
        }
    });  
      return false;
