   ...
   <div class="inner-wrapper"> 
    ...
    <section role="main" class="content-body">
     <header class="page-header">  
      <h2>Master Data penjual</h2>
  </header>  
  <!-- start: page -->
  <section class="panel">
    <header class="panel-heading">    
        <div class="row show-grid">
            <div class="col-md-6" align="left"><h2 class="panel-title">Data penjual</h2></div>
            <?php  
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <section class="panel panel-primary">
                <?php echo form_open('master/penjualtambah',' id="FormulirTambah"');?>  
                <header class="panel-heading">
                    <h2 class="panel-title">Tambah penjual</h2>
                </header>
                <div class="panel-body">
                ...
                <div class="form-group mt-lg regional">
...
<div class="modal fade" data-keyboard="false" data-backdrop="static"  id="detailData" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <section class="panel  panel-primary">   
                <header class="panel-heading">
                    <h2 class="panel-title">Detail penjual</h2>
                </header>
...
<div class="modal fade" data-keyboard="false" data-backdrop="static"  id="editData" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <section class="panel  panel-primary">
                <?php echo form_open('master/penjualedit',' id="FormulirEdit"');?>  
                <input type="hidden" name="idd" id="idd">
                <header class="panel-heading">
                    <h2 class="panel-title">Edit Data penjual</h2>
                </header>
                <div class="panel-body">
                   <div class="form-group mt-lg ">
                    <label class="col-sm-3 control-label">NIK<span class="required">*</span></label>
  ...
  <div class="modal fade" data-keyboard="false" data-backdrop="static"  id="daftar_akun" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                <section class="panel panel-primary">
                    ...
                    <div class="panel-body">
                            ...
                            <input type="hidden" name="nama_admin" id="nama_penjual_2">
                            ...
                            <div class="form-group mt-lg nama_penjual">
                                <label class="col-sm-3 control-label">Nama penjual<span class="required">*</span></label>
                                <div class="col-sm-9">
                                    <input type="text" name="nama_penjual" readonly id="nama_penjual_akun" class="form-control"/>
                                </div>
                            </div>
        ...
        <div class="modal-content">
            <section class="panel  panel-danger">
                ...
                <footer class="panel-footer"> 
                    <div class="row">
                        <div class="col-md-12 text-right"> 
                            <?php echo form_open('master/penjualhapus',' id="FormulirHapus"');?>  
...
<script type="text/javascript"> 
  ...
  var tablepembeli = $('#pembelidata').DataTable({  
    ...
    "order": [], 
    "ajax": {
        "url": "<?php echo base_url()?>master/datapenjual",
        "type": "GET"
    }, 
    "columnDefs": [
    { 
...
e.preventDefault(); 
  ...
  function detail(elem){
      ...
      $.ajax({
        type: 'GET',
        url: '<?php echo base_url()?>master/penjualdetail',
        data: 'id=' + dataId,
        dataType 	: 'json',
        success: function(response) { 
            ...
            $.each(response, function(i, item) {
                ...
                datarow+="<tr><td>Regional </td><td>: "+item.nama_regional+"</td></tr>";
  ...
  function edit(elem){
      ...
      $.ajax({
        ...
        success: function(response) {  
            $.each(response, function(i, item) { 
                ...
                document.getElementById("kontak").value = item.kontak;
                document.getElementById("target").value = item.target;
                document.getElementById("regional_edit").value = item.regional;
            }); 
        }
    });  
      return false;
    ...
    function daftar_akun(elem){
      var dataId = $(elem).data("id_penjual");   
      var datanama = $(elem).data("nama_penjual");   
      document.getElementById("id_penjual").setAttribute('value', dataId);
      document.getElementById("nama_penjual_akun").setAttribute('value', datanama);
      document.getElementById("nama_penjual_2").setAttribute('value', datanama);
      $('#daftar_akun').modal();        
      return false;
  }
