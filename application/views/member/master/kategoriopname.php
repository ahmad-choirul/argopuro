	...
	<body class="bgbody">
			...
			<div class="inner-wrapper"> 
				...
				<section role="main" class="content-body">
					<header class="page-header">  
						<h2>Master Data Kategori Opname</h2>  
					</header>  
					<!-- start: page -->
                    <section class="panel">
                        <header class="panel-heading">    
                            <div class="row show-grid">
                                <div class="col-md-6" align="left"><h2 class="panel-title">Data Kategori Opname</h2></div>
                                <?php  
        ...
        <div class="modal fade" id="tambahData" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                ...
                <section class="panel  panel-primary">
                    <?php echo form_open('master/kategoriopnametambah',' id="FormulirTambah"');?>  
                    <header class="panel-heading">
                        <h2 class="panel-title">Tambah Kategori Opname</h2>
                    </header>
                    <div class="panel-body">
        ...
        <div class="modal fade" id="editData" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                <section class="panel  panel-primary">
                    <?php echo form_open('master/kategoriopnameedit',' id="FormulirEdit"');?>  
            ...
            <div class="modal-dialog">
                ...
                <section class="panel  panel-danger">
                    ...
                    <footer class="panel-footer"> 
                        <div class="row">
                            <div class="col-md-12 text-right"> 
                                <?php echo form_open('master/kategoriopnamehapus',' id="FormulirHapus"');?>  
		...
		<script type="text/javascript"> 
            var tablekategori = $('#kategoridata').DataTable({  
                ...
                "order": [], 
                "ajax": {
                    "url": "<?php echo base_url()?>master/datakategoriopname",
                    "type": "GET"
                }, 
                "columnDefs": [
                    { 
            ...
            function edit(elem){
                ...
                $.ajax({
                    type: 'GET',
                    url: '<?php echo base_url()?>master/kategoriopnamedetail',
                    data: 'id=' + dataId,
                    dataType 	: 'json',
                    success: function(response) {  
                        $.each(response, function(i, item) { 
                        document.getElementById("idd").setAttribute('value', item.id);
                        document.getElementById("nama_kategori").setAttribute('value', item.kategori);
                        }); 
                    }
                });  
                return false;
