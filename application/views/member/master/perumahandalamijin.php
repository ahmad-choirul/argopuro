      ...
      <section class="panel  panel-primary">
        ...
        <div class="panel-body">
          ...
          <div class="form-group mt-lg nama_target">
            ...
            <div class="col-sm-9">
              <input type="hidden" name="status_regional" value="1" class="form-control" required/>
              <input type="text" readonly value="Dalam Ijin" class="form-control" required/>
...
<script type="text/javascript"> 
  var tablekategori = $('#kategoridata').DataTable({  
    ...
    "order": [], 
    "ajax": {
      "url": "<?php echo base_url()?>master/datakategori/1",
      "type": "GET"
    }, 
    "columnDefs": [
    { 
