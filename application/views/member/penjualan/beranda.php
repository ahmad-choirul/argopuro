											...
											<div class="sidebar-widget m-none"> 
												<div class="widget-content">
													<ul class="mg-folders" style="background-color: #003659;">
                                                        <li>
                                                            <a href="<?php echo base_url()?>penjualan/diskon" class="menu-item" style="color: white;"><i class="fa fa-folder" ></i> Diskon Produk</a>
                                                        ...
                                                        <!-- <li>
                                                            <a href="<?php echo base_url()?>penjualan/kasir" class="menu-item"><i class="fa fa-folder"></i> Point Of penjual / Kasir</a>
                                                            <div class="item-options">
