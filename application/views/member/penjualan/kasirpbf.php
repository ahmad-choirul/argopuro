		...
		<div class="modal-content">
			<section class="panel panel-primary">
				...
				<div class="panel-body">
					...
					<div class="form-group mt-lg nama_pembeli">
                                <label class="col-sm-3 control-label">Limit Kredit<span class="required">*</span></label>
                                <div class="col-sm-9">
                                    <input type="text" name="limit_kredit" id="limit_kredit" class="form-control mask_price" required/>
                                </div>
                            </div>
		...
		function keranjang(){   
            ...
            $(document).on('click','#modal-payment #paymenttransaksi',function(e) { // tombol paymenttransaksi sg ono ng modal payment
            	...
            	if (totalbayar<=totalbelanja) {
            		...
            		window.setTimeout(function() {  
            			new PNotify({
            				title: 'Notifikasi',
            				text: 	'Maaf, periksa inputan total bayar anda'+totalbayar+' / '+totalbelanja,
            				type: 'warning',
            ...
            $(document).on('click','#modal-payment #paymenttransaksikredit',function(e) { // tombol paymenttransaksikredit sg ono ng modal payment
            	...
            	if (tanggal_jatuh_tempo!=null) {
            		...
            		$('#modal-payment form').attr('action','<?=base_url()?>penjualan/struk_kredit?t='+idk+'&spg='+spg+'&tmp='+tmp+'&idd='+idkd+'&bayar=0&jns_penjualan='+jns_penjualan)
            		.submit()
            	}else{
            		window.setTimeout(function() {  
            			new PNotify({
