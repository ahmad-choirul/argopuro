...
<script type="text/javascript">
    ...
    function searchFilter(page_num) { 
     ...
     $.ajax({
        type: 'GET',
        url: '<?php echo base_url(); ?>laporan/laporanpenjualan_kasir/'+page_num,
        data: 'page='+page_num+'&kasir='+id_admin+'&obat='+obat+'&id_penjualan='+id_penjualan+'&costumer='+costumer+'&firstdate='+firstdate+'&lastdate='+lastdate,success: function (html) { 
           $('#postList').html(html);
