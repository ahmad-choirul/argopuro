                    ...
                    <table class="table table-bordered table-hover table-striped" id="itemsdata">
                        <thead>
                            <tr>
                                ...
                                <th  colspan="3" style="text-align: center;">PROSES SPLITSING</th>
                                <th colspan="12" style="text-align: center;">TERBIT TAHUN 2020</th>
                                <th rowspan="2" style="text-align: center;">SISA BELUM TERBIT</th>
