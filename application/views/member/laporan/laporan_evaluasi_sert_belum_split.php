            ...
            <table class="table table-bordered table-hover table-striped" id="itemsdata">
                <thead>
                    <tr>
                        ...
                        <th  colspan="3" style="text-align: center;">HUTANG PENJUALAN BELUM TERBIT SPLIT</th>
                        <th colspan="12" style="text-align: center;">TERBIT SPLIT TAHUN 2020</th>
                        <th rowspan="2" style="text-align: center;">SISA HUTANG</th>
                        <th colspan="2" style="text-align: center; ">EVALUASI</th>
