...
<html class="fixed sidebar-left-collapsed">
	...
	<body class="bgbody">
			...
			<div class="inner-wrapper"> 
				...
				<section role="main" class="content-body">
					<header class="page-header">  
						<h2>Laporan investor</h2>
					</header>  
                    <form id="Formulir" method="GET" action="<?php echo base_url();?>laporan/excel_investor/" target="_blank">
					<!-- start: page --> 
                    <section class="panel"> 
                    ...
                    <section class="panel" id="KontenHTML"> 
                        <div class="panel-body"> 
                            ...
                            <tr>
                                <td><?php echo date('H:i:s', strtotime($post['waktu_investor'])).", ".tgl_indo(date('Y-m-d', strtotime($post['waktu_investor']))); ?></td>
        ...
        function searchFilter(page_num) { 
            ...
            $.ajax({
				type: 'GET',
				url: '<?php echo base_url(); ?>laporan/laporan_investor/'+page_num,
