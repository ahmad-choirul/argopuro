     ...
     <div class="inner-wrapper"> 
        ...
        <section role="main" class="content-body">
           <header class="page-header">  
              <h2>Master Data sertifikat_tanah</h2>  
          </header>  
          <!-- start: page -->
          <section class="panel">
            <header class="panel-heading">    
                <div class="row show-grid">
                    <div class="col-md-6" align="left"><h2 class="panel-title">Data sertifikat_tanah</h2></div>
                    <?php  
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <section class="panel panel-primary">
                ...
                <header class="panel-heading">
                    <h2 class="panel-title">Edit sertifikat_tanah</h2>
                </header>
                <div class="panel-body">
                    <div class="form-group mt-lg kode_sertifikat">
                        <label class="col-sm-3 control-label">Kode Sertifikat<span class="required">*</span></label>
