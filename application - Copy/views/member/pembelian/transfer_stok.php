                                            ...
                                            <div class="panel-body bg-primary">
                                                <div class="widget-summary"> 
                                                    <div class="widget-summary-col">
                                                        <div class="summary">
                                                            <h4 class="title">Jumlah Produk yg dibawa</h4>
                                                            <div class="info">
                                        ...
                                        <section class="panel">
                                            <div class="panel-body bg-primary">
                                                <div class="widget-summary"> 
                                                    <div class="widget-summary-col">
                                                        <div class="summary">
                                                            <h4 class="title">Jumlah transfer stok bulan ini</h4>
                                                            <div class="info">
                                        ...
                                        <section class="panel">
                                            <div class="panel-body bg-primary">
                                                <div class="widget-summary"> 
                                                    <div class="widget-summary-col">
                                                        <div class="summary">
                                                            <h4 class="title">Jumlah Jumlah produk terjual</h4>
                                                            <div class="info">
                    ...
                    <section class="panel">
                        <header class="panel-heading">    
                            <div class="row show-grid">
                                <div class="col-md-6" align="left"><h2 class="panel-title">Data Transfer</h2></div>
                                <?php  
                        ...
                        <div class="panel-body"> 
                                <table class="table table-bordered table-hover table-striped" id="datatransfer">
                                    <thead>
                                        <tr>
                                            <th></th>
                ...
                <section class="panel panel-primary">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group mt-lg nomor_po">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="nomor_po" class="form-control" value="" required/>
                                </div>
                            </div>
                    ...
                    <div class="row" style="overflow-x: auto;white-space: nowrap;"> 
                        <div class="col-md-12">
                            <h3>Rincian Item Yang Diambil</h3> 
                            ...
                            <div class="table-responsive" style="max-height:420px;"> 
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th style="min-width:100px;">Sisa Barang</th> 
                ...
                <section class="panel panel-primary">   
                    <header class="panel-heading">
                        <div class="row">
                            ...
                            <h2 class="panel-title">Transfer Stok</h2>  
                            </div>
...
<script src="<?php echo base_url()?>assets/javascripts/admin.min.js"></script>
        ...
        var tablepo = $("#datatransfer").dataTable({ 
            serverSide: true,
            ajax: {
        ...
        document.getElementById("FormulirTambah").addEventListener("submit", function (e) {  
			...
			if ( ! data.success) {	 
                    ...
                    $('input[name=<?php echo $this->security->get_csrf_token_name();?>]').val(data.token);
                    PNotify.removeAll(); 
					$('#datatransfer').dataTable().api().ajax.reload();
					laporan_ringkas();			
                    document.getElementById("submitform").removeAttribute('disabled'); 
        ...
        $(add_button_mg).click(function(e){
            ...
            if(x < max_fields){
                ...
                formtambah+='<td><input type="text" readonly class="form-control nama-item'+x+'"></td>';
                
                formtambah+='<td><input type="text" readonly class="form-control stok'+x+'"></td>';
                formtambah+='<td><input type="number" name="kuantiti[]" class="form-control"></td>';
                 formtambah+='<td><input type="hidden" class="kode-item'+x+'" name="kode_item[]"><input type="hidden" class="nama-item'+x+'" name="nama_item[]"></td>';
        ...
        $(add_button_mgEdit).click(function(e){
            ...
            if(x < max_fieldsEdit){
                ...
                formtambah+='<td><input type="text"  class="form-control stok'+x+'"></td>';
                formtambah+='<td><input type="number" name="kuantiti[]" class="form-control"></td>';
