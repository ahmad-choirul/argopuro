          ...
          <form action="" method="get">
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <select data-plugin-selectTwo class="form-control" name="jns_select" id="jns_select">    
                  <option value="">Cari semua</option>
                  <option value="rec_penerimaan" <?php echo ($jns_select == 'rec_penerimaan') ? 'selected' : ''; ?>>rec penerimaan</option>
                  <option value="id_utility" <?php echo ($jns_select == 'id_utility') ? 'selected' : ''; ?>>ID Utility</option>
                  <option value="id_stok_opname" <?php echo ($jns_select == 'id_stok_opname') ? 'selected' : ''; ?>>Stok Opname</option>
                  <option value="id_stok_keluar" <?php echo ($jns_select == 'id_stok_keluar') ? 'selected' : ''; ?>>Stok Keluar</option>
                  <option value="id_penjualan" <?php echo ($jns_select == 'id_penjualan') ? 'selected' : ''; ?>>Penjualan</option>
                </select> 

              <div class="input-group input-group-sm">
                <input type="text" name="search_jns_select" id="search_jns_select" placeholder="Masukan Parameter pencarian" value="<?php echo $search_jns_select ?>" class="form-control">
 ...
 var tableitems = $('#itemsdata').DataTable({  
  ...
  "ajax": {
   ...
   "data": function ( data ) {
    ...
    data.jns_select = $('#jns_select').val();
    data.search_jns_select = $('#search_jns_select').val();
  }
}, 
"columnDefs": [
{ 
