...
<body class="bgbody">
            ...
            <section role="main" class="content-body">
                    ...
                    <header class="panel-heading">
                        <div class="row show-grid">
                            <div class="col-md-6" align="left">
                                <h2 class="panel-title">Data Piutang Jatuh Tempo</h2>
                            </div>
                            <?php
                            echo level_user('keuangan', 'piutang', $this->session->userdata('kategori'), 'add') > 0 ? '<div class="col-md-6" align="right"><a class="btn btn-success" href="#"  data-toggle="modal" data-target="#tambahData"><i class="fa fa-plus"></i> Tambah</a></div>' : '';
                            ?>
                        </div>
                    </header>
                    <div class="panel-body">
                ...
                <section class="panel">
                    <header class="panel-heading">
                        <div class="row show-grid">
                            <div class="col-md-6" align="left">
                                <h2 class="panel-title">Data Piutang Belum Jatuh Tempo</h2>
                            </div>
                            <?php
                            echo level_user('keuangan', 'piutang', $this->session->userdata('kategori'), 'add') > 0 ? '<div class="col-md-6" align="right"><a class="btn btn-success" href="#"  data-toggle="modal" data-target="#tambahData"><i class="fa fa-plus"></i> Tambah</a></div>' : '';
                            ?>
                    ...
                    <div class="panel-body">
                        <table class="table table-bordered table-hover table-striped" id="hutangdata2">
                            <thead>
                                <tr>
                                    <th></th>
                                    <th>ID</th>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <section class="panel panel-primary">
                    <?php echo form_open('keuangan/piutangtambah', ' id="FormulirTambah"'); ?>
                    <header class="panel-heading">
                        <h2 class="panel-title">Tambah Piutang</h2>
                    </header>
                    <div class="panel-body">
                        <div class="form-group mt-lg id_pembeli">
                            <label class="col-sm-3 control-label">Pilih Pembeli<span class="required">*</span></label>
                            <div class="col-sm-9">
                                <select data-plugin-selectTwo class="form-control" name="id_pembeli" required>
                                    <?php foreach ($pembeli as $supp) : ?>
                        ...
                        <div class="form-group mt-lg tanggal">
                            <label class="col-sm-3 control-label">Tanggal Piutang<span class="required">*</span></label>
                            <div class="col-sm-9">
                ...
                <section class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        <div class="form-group mt-lg id_pembeli">
                            <label class="col-sm-3 control-label">Pilih Pembeli<span class="required">*</span></label>
                            <div class="col-sm-9">
                                <select data-plugin-selectTwo class="form-control" id="id_pembeli" name="id_pembeli" disabled>
                                    <?php foreach ($pembeli as $supp) : ?>
                                        <option value="<?php echo $supp->id; ?>"><?php echo $supp->nama_pembeli; ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                            <input type="hidden" name="idd_pembeli" id="idd_pembeli" class="form-control" readonly />
                        </div>
                        <div class="form-group mt-lg judul">
                            <label class="col-sm-3 control-label">Judul<span class="required">*</span></label>
                            <div class="col-sm-9">
                        ...
                        <div class="form-group mt-lg">
                            <label class="col-sm-3 control-label">Total Piutang<span class="required">*</span></label>
                            <div class="col-sm-9">
            ...
            <div class="modal-content">
                <section class="panel  panel-danger">
                    ...
                    <footer class="panel-footer">
                        <div class="row">
                            <div class="col-md-12 text-right">
                                <?php echo form_open('keuangan/piutanghapus', ' id="FormulirHapus"'); ?>
                    ...
                    <header class="panel-heading">
                        <div class="row">
                            <div class="col-md-3 text-left">
                                <h2 class="panel-title">Pembayaran Piutang</h2>
                            </div>
                        </div>
                    </header>
    ...
    <script type="text/javascript">
        ...
        var tablehutang = $('#hutangdata').DataTable({
            ...
            "order": [],
            "ajax": {
                "url": "<?php echo base_url() ?>keuangan/datapiutang/belum",
                "type": "GET",
                "data": function(data) {
        ...
        var tablehutang2 = $('#hutangdata2').DataTable({
            "serverSide": true,
            "order": [],
            "ajax": {
                "url": "<?php echo base_url() ?>keuangan/datapiutang/jatuh_tempo",
                "type": "GET",
                "data": function(data) {
                    data.firstdate = $('#firstdate').val();
                    data.lastdate = $('#lastdate').val();
            ...
            $.ajax({
                ...
                success: function(response) {
                    $.each(response, function(i, item) {
                        ...
                        $('#total_hutang_belum_bayar').html(item.total_piutang_belum_bayar);
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $.each(response.datarows, function(i, item) {
                        ...
                        datarow += "<tr><td>Nomor Penjualan</td><td>: " + item.id_penjualan + "</td></tr>";
                        ...
                        datarow += "<tr><td>Kode Pembeli</td><td>: " + item.id_pembeli + "</td></tr>";
                        datarow += "<tr><td>Pembeli</td><td>: " + item.nama_pembeli + "</td></tr>";
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $.each(response.datarows, function(i, item) {
                        ...
                        $("#id_pembeli").select2("val", item.id_pembeli);
                        document.getElementById("idd_pembeli").value = item.id_pembeli;
