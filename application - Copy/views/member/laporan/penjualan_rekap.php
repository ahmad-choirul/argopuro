...
<body class="bgbody">
  <section class="body">
   ...
   <div class="inner-wrapper"> 
    ...
    <form id="Formulir" method="GET" action="<?php echo base_url();?>laporan/excel_penjualan_rekap/" target="_blank">
     <!-- start: page --> 
     <section class="panel"> 
...
<script type="text/javascript">
  ...
  function searchFilter(page_num) { 
   ...
   $.ajax({
    type: 'GET',
    url: '<?php echo base_url(); ?>laporan/laporanpenjualan_rekap/'+page_num,
    data: 'page='+page_num+'&kasir='+id_admin+'&obat='+obat+'&costumer='+costumer+'&firstdate='+firstdate+'&lastdate='+lastdate,success: function (html) { 
     $('#postList').html(html);
