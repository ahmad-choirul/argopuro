									...
									if (empty($posts)) {
										...
										foreach($posts as $post): ?> 
											<tr> 
												...
												<td><?php echo rupiah($post['harga_jual']); ?></td>  
												<td><?php echo rupiah($post['harga_jual_distributor']); ?></td>
												<td><?php echo rupiah($post['harga_jual_3']); ?></td>
												<td><?php echo rupiah($post['harga_jual_4']); ?></td>
												<td><?php echo rupiah($post['komisi']); ?></td>
												<td><?php echo rupiah($post['harga_beli']); ?></td>
