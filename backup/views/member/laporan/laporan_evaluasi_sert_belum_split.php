   ...
   <div class="inner-wrapper"> 
    ...
    <section role="main" class="content-body">
     <header class="page-header">  
      <h2>REKAPITULASI DATA HUTANG SERTIFIKAT BELUM TERBIT SPLITSING</h2>
  </header>  
  <!-- start: page -->
  <section class="panel">
            ...
            <table class="table table-bordered table-hover table-striped data" id="itemsdata">
                <thead>
                    <tr>
                        ...
                        <th  colspan="3" style="text-align: center;vertical-align: middle;">HUTANG PENJUALAN BELUM TERBIT SPLIT</th>
                        <th colspan="12" style="text-align: center;vertical-align: middle;">TERBIT SPLIT TAHUN 2020</th>
                        <th rowspan="2" style="text-align: center;vertical-align: middle;">SISA HUTANG</th>
                        <th colspan="2" style="text-align: center;vertical-align: middle; ">EVALUASI</th>
