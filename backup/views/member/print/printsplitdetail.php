...
<head>
    <meta charset="utf-8">
	<title>ID Split <?php echo $data['id_split'];?></title> 
    <style>
    .invoice-box {
        width: 21cm;
        margin: auto;
                            ...
                            <td align="right" width="50%">
                                <table>
                                    <tr>
                                        <td>Nomor PO</td>
                                        <td width="5%">:</td>
                                        <td># <?php echo $data['id_split'];?></td>
                                    </tr>
                                    <tr>
                                        <td>Tanggal PO</td>
                                        <td width="5%">:</td>
                                        <td><?php echo tgl_indo($data['tgl_po']); ?></td>
                                    </tr>
                                    <tr>
                                        <td>Pembayaran</td>
                                        <td>:</td>
                                    ...
                                    <tr>
                                        <td>Nama target</td>
                                        <td>:</td>
                                        <td> <?php echo $this->security->xss_clean($data['nama_target']);?></td>
							  </tr> 
                                    <tr>
                                        <td>Telp</td>
                                        <td>:</td>
                                        <td> <?php echo $this->security->xss_clean($data['telepon']);?></td>
							        </tr> 
                                </table>
            ...
            <tr>
                <td><b>Keterangan : </b>
                    <table class="footer" style="width:400px;"> 
                        <tr> 
                         <td><?php echo $this->security->xss_clean($data['keterangan']);?> <br/></td>
                        </tr>
                    </table>
                </td>
            </tr> 
