                ...
                <section class="panel  panel-primary">
                    ...
                    <div class="panel-body">
                        <!-- apotek -->
                            ...
                            <label class="col-sm-3 control-label">Email Supplier <span class="required">*</span></label>
                            <div class="col-sm-9">
                            ...
                            <div class="form-group masa_apoteker">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="tgl_sipa" class="form-control tanggal_sipa" data-plugin-datepicker required/>
                                </div>
                            </div> 
                            <div class="form-group mt-lg nama_supplier">
							...
							<div class="form-group mt-lg nama_supplier">
                                <label class="col-sm-3 control-label">No TTK<span class="required">*</span></label>
                                <div class="col-sm-9">
                                    <input type="text" name="no_ttk" class="form-control" required/>
                                </div>
                            </div>
                            <div class="form-group ">
                            <label class="col-sm-3 control-label">Masa Berlaku TTK<span class="required">*</span></label>
                            <div class="col-sm-9">
                                <input type="text" name="tgl_ttk" class="form-control tgl_ttk" data-plugin-datepicker required />
                            </div>
                        </div>
                        <div class="form-group ">
                            <label class="col-sm-3 control-label">No. Hp Bagian Order <span class="required">*</span></label>
                            <div class="col-sm-9">
                                <input type="text" name="hp_order" class="form-control" required />
                            </div>
                        </div>
                    </div>
            ...
            <div class="modal-dialog">
                ...
                <section class="panel  panel-primary">
                    ...
                    <div class="panel-body">
                            ...
                            <label class="col-sm-3 control-label">Email Apotek<span class="required">*</span></label>
                            <div class="col-sm-9">
							...
							<div class="form-group mt-lg nama_supplier">
                                <label class="col-sm-3 control-label">No TTK<span class="required">*</span></label>
                                <div class="col-sm-9">
                                    <input type="text" name="no_ttk" id="no_ttk" class="form-control" required/>
                                </div>
                            </div> 
                            <div class="form-group ">
                            <label class="col-sm-3 control-label">Masa Berlaku TTK<span class="required">*</span></label>
                            <div class="col-sm-9">
                                <input type="text" name="tgl_ttk" id="tgl_ttk" class="form-control tgl_ttk" data-plugin-datepicker required />
                            </div>
                        </div>
                        <div class="form-group ">
                            <label class="col-sm-3 control-label">No. Hp Bagian Order<span class="required">*</span></label>
                            <div class="col-sm-9">
                                <input type="text" name="hp_order" id="hp_order" class="form-control" required />
                            </div>
                        </div>
                    </div>
                    <footer class="panel-footer">
            ...
            function edit(elem){
                ...
                $.ajax({
                    ...
                    success: function(response) {  
                        ...
                        document.getElementById("tgl_sipa").value = item.tgl_sipa;
                        document.getElementById("nama_ttk").value = item.nama_ttk;
						document.getElementById("no_ttk").value = item.no_ttk;
                        document.getElementById("tgl_ttk").value = item.tgl_ttk;
                        document.getElementById("hp_order").value = item.hp_order;
                        }); 
                    }
                });  
                return false;
