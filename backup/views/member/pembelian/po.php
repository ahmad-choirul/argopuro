	...
	<body class="bgbody">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group mt-lg nomor_po">
                            ...
                            <div class="form-group mt-lg tgl_po">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="tgl_po" class="form-control tanggal"  autocomplete="off"data-plugin-datepicker required/>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group diskon_deal">
                                <label class="col-sm-3 control-label">Diskon Deal<span class="required">*</span></label>
                                <div class="col-sm-9">
                                     <input type="text" name="diskon_deal" class="form-control mask_price" required />
                                </div>
                            </div>
                            <div class="form-group harga_jadi">
                                <label class="col-sm-3 control-label">Harga Jadi<span class="required">*</span></label>
                                <div class="col-sm-9">
                                     <input type="text" name="harga_jadi" class="form-control mask_price" required />
                                </div>
                            </div>
                        </div>
                    </div> 
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group mt-lg tgl_po">
                                <label class="col-sm-3 control-label">Tanggal PO<span class="required">*</span></label>
                                <div class="col-sm-9">
                                    <input type="text" name="tgl_po" id="tgl_po" class="form-control tanggal"  autocomplete="off"data-plugin-datepicker required/>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group diskon_deal">
                                <label class="col-sm-3 control-label">Diskon Deal<span class="required">*</span></label>
                                <div class="col-sm-9">
                                     <input type="text" name="diskon_deal" id="diskon_deal" class="form-control mask_price" required />
                                </div>
                            </div>
                            <div class="form-group harga_jadi">
                                <label class="col-sm-3 control-label">Harga Jadi<span class="required">*</span></label>
                                <div class="col-sm-9">
                                     <input type="text" name="harga_jadi" id="harga_jadi" class="form-control mask_price" required />
                                </div>
                            </div>
                        </div>
                    </div> 
            ...
            $.ajax({
                ...
                success: function(response) { 
                    ...
                    $.each(response.datarows, function(i, item) {
                        ...
                        datarow+="<tr><td>Diskon Deal</td><td>: "+item.diskon_deal+"</td></tr>";
                        datarow+="<tr><td>Harga Jadi</td><td>: "+item.harga_jadi+"</td></tr>";
                        datarow+="</table>";
                        datarow+='</div>';
                    });
                    datarow+='</div>';
        ...
        $(add_button_mg).click(function(e){
            ...
            if(x < max_fields){
                ...
                formtambah+='<td><select name="satuan_besar[]">';
				<?php foreach ($satuan as $sat): ?>
                                        formtambah+="<option value='<?php echo $sat->id;?>'><?php echo $sat->id;?></option>";
                                        <?php endforeach; ?>
				formtambah+='</select></td>';
                ...
                $.ajax({
                    ...
                    success: function(response) {  
                        $.each(response.datarows, function(i, item) {                 
                            ...
                            document.getElementById("diskon_deal").value = item.diskon_deal;  
                            document.getElementById("harga_jadi").value = item.harga_jadi;  
                        });  
