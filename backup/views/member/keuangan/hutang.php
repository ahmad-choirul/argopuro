...
<html class="fixed sidebar-left-collapsed">
  ...
  <link rel="stylesheet" href="<?php echo base_url()?>/assets/stylesheets/admin.min.css">
	...
	<body class="bgbody">
        ...
        <div class="modal fade" data-keyboard="false" data-backdrop="static"  id="tambahbayarHutang" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                <section class="panel panel-primary">
